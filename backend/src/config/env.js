...
const env = {
  ...
  openAiTimeoutMs: boundedTimeout(process.env.OPENAI_TIMEOUT_MS, 10000, 1000, 15000),
  openAiMaxRetries: Math.min(1, Math.max(0, Number(process.env.OPENAI_MAX_RETRIES || 0))),
